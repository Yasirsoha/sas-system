...
const comp_dashboard =
    require("./components/layout/company_dashboard.vue").default;
...
Vue.component(
    "login_page",
    require("./components/user_folder/login_page.vue").default
);
Vue.component("navbar1", require("./components/layout/navbar1.vue").default);
Vue.component(
    "mainmenu1",
    require("./components/layout/mainmenu1.vue").default
);
Vue.component("mainmenu", require("./components/layout/mainmenu.vue").default);
Vue.component(
    "main_dashboard",
    require("./components/main_dashboard.vue").default
);
const create_company =
    require("./components/layout/create_company.vue").default;
const chat = require("./components/layout/chat.vue").default;
const overall_companies =
    require("./components/layout/overall_companies.vue").default;
const company_detail =
    require("./components/layout/company_detail.vue").default;
...
const users_page =
    require("./components/client_admin_side/users_page.vue").default;
const create_user =
    require("./components/client_admin_side/create_user.vue").default;
const location_detail =
    require("./components/client_admin_side/location_detail.vue").default;
const designation_detail =
    require("./components/client_admin_side/designation_detail.vue").default;
const department_detail =
    require("./components/client_admin_side/department_detail.vue").default;
const activity_log =
    require("./components/client_admin_side/activity_log.vue").default;
const update_user =
    require("./components/client_admin_side/update_user.vue").default;
...
const account_dash =
    require("./components/hr_folder/account_dashboard.vue").default;
const hr_employee_detail =
    require("./components/hr_folder/hr_employee_detail.vue").default;
const employee_detail =
    require("./components/hr_folder/ind_employee_detail.vue").default;
const employee_leaves =
    require("./components/hr_folder/ind_employee_leaves.vue").default;
const employee_attendance =
    require("./components/hr_folder/ind_employee_attendance.vue").default;
const employee_financial =
    require("./components/hr_folder/ind_employee_financial.vue").default;
const employee_perfomance =
    require("./components/hr_folder/ind_employee_connection.vue").default;
const create_employee =
    require("./components/hr_folder/hr_create_employee.vue").default;
const create_employee_education =
    require("./components/hr_folder/hr_create_emp_education.vue").default;
const create_employee_experience =
    require("./components/hr_folder/hr_create_emp_experience.vue").default;
const create_employee_employeement =
    require("./components/hr_folder/hr_create_emp_employment.vue").default;
const edit_employee =
    require("./components/hr_folder/hr_edit_employee.vue").default;
const update_employee_profile =
    require("./components/hr_folder/update_employee_profile.vue").default;
const update_education_profile =
    require("./components/hr_folder/update_education_profile.vue").default;
const create_documents =
    require("./components/hr_folder/ind_documents.vue").default;

const update_experience_profile =
    require("./components/hr_folder/update_experience_profile.vue").default;
const warning_detail =
    require("./components/hr_folder/hr_warning_detail.vue").default;
const warning_view =
    require("./components/hr_folder/hr_warning_view.vue").default;
...
const attendance_grace_periods =
    require("./components/hr_folder/attendance_grace_periods.vue").default;
const hr_attendance_dashboard =
    require("./components/hr_folder/hr_attendance_dashboard.vue").default;
const hr_attendance_emp =
    require("./components/hr_folder/hr_emp_att_detail.vue").default;
const hr_emp_overtime =
    require("./components/hr_folder/hr_emp_att_overtime.vue").default;
const hr_leaves_detail =
    require("./components/hr_folder/hr_leaves_dashboard.vue").default;

const int_att =
    require("./components/hr_folder/hr_team_member_att.vue").default; //individual team member attandence
const ind_view_dashboard =
    require("./components/hr_folder/ind_view_dashboard.vue").default;
const ind_team_attendance =
    require("./components/hr_folder/ind_team_attendance.vue").default;
const ind_emp_detail =
    require("./components/hr_folder/ind_emp_detail.vue").default;
const hr_controller =
    require("./components/hr_folder/hr_controller.vue").default;
const hr_configuration =
    require("./components/hr_folder/hr_configuration.vue").default;
const employee_all_leaves =
    require("./components/hr_folder/hr_leaves.vue").default;
const team_leaves =
    require("./components/hr_folder/hr_leaves_team.vue").default;

//Recruitment components
const recruitment_jobs = require("./components/Hr_Rec/jobs.vue").default;
const recruitment_job_detail =
    require("./components/Hr_Rec/job_details.vue").default;
const recruitment_candidates =
    require("./components/Hr_Rec/candidates.vue").default;
const recruitment_interviews =
    require("./components/Hr_Rec/interviews.vue").default;
const recruitment_dashboard =
    require("./components/Hr_Rec/rec_dashboard.vue").default;

//Payroll dashboard
const advance_loans =
    require("./components/payroll_folder/py_loan.vue").default;

const py_salary_generation =
    require("./components/payroll_folder/py_salary_generation.vue").default;

const payroll_employees_detail =
    require("./components/payroll_folder/payroll_employees_detail.vue").default;
const payroll_hr_approval =
    require("./components/payroll_folder/payroll_hr_approval.vue").default;
const payroll_finance_approval =
    require("./components/payroll_folder/payroll_finance_approval.vue").default;
const payroll_distribution =
    require("./components/payroll_folder/payroll_distribution.vue").default;
const payroll_arrears =
    require("./components/payroll_folder/py_arrears.vue").default;
const payroll_bonuses =
    require("./components/payroll_folder/py_bonuses.vue").default;
const payroll_dues = require("./components/payroll_folder/py_dues.vue").default;
const payroll_allowance =
    require("./components/payroll_folder/py_allowance.vue").default;
const payroll_cash_distribution =
    require("./components/payroll_folder/payroll_cash_distribution.vue").default;

//payroll_arrears

const ind_emp_leaves =
    require("./components/hr_folder/ind_emp_leaves.vue").default;
const ind_emp_attendance =
    require("./components/hr_folder/ind_emp_attendance.vue").default;
/**
...
const config_general =
    require("./components/accounts/config_general.vue").default;
const accounts_session =
    require("./components/accounts/confg_accounts_sessions.vue").default;
const currencies =
    require("./components/accounts/confg_currencies.vue").default;
const product_categories =
    require("./components/accounts/confg_products_categories.vue").default;
const acc_heads_types =
    require("./components/accounts/confg_acc_heads_types.vue").default;
...
const confg_payment_terms =
    require("./components/accounts/payment_terms.vue").default;
const sales_customer_details =
    require("./components/accounts/sales_customer_detail.vue").default;
const products_detail =
    require("./components/accounts/products_detail.vue").default;
const sales_invoice =
    require("./components/accounts/sales_invoice.vue").default;
const sales_invoice_detail =
    require("./components/accounts/sales_invoice_detail.vue").default;
const sales_received_voucher_detail =
    require("./components/accounts/sales_payment_received_detail.vue").default;
const sales_received_voucher =
    require("./components/accounts/sales_received_voucher.vue").default;
const create_credit_notes =
    require("./components/accounts/sales_credit_notes.vue").default;
const credit_notes_detail =
    require("./components/accounts/sales_credit_notes_detail.vue").default;
const sales_quotation =
    require("./components/accounts/sales_quotation.vue").default;
const sales_quotation_detail =
    require("./components/accounts/sales_quotation_detail.vue").default;
const purchase_po_detail =
    require("./components/accounts/purchase_po_detail.vue").default;
const purchase_po_create =
    require("./components/accounts/purchase_po_create.vue").default;
const requistion_detail =
    require("./components/accounts/purchase_requistion_detail.vue").default;
const requistion_create =
    require("./components/accounts/purchase_requistion.vue").default;
const purchase_vendor_detail =
    require("./components/accounts/purchase_vendor_detail.vue").default;
const purchase_payment_voucher_detail =
    require("./components/accounts/purchase_payment_detail.vue").default;
const create_payment_voucher =
    require("./components/accounts/purchase_payment_voucher.vue").default;
const create_debit_notes =
    require("./components/accounts/purchase_debit_notes.vue").default;
const credit_debit_detail =
    require("./components/accounts/purchase_debit_note_detail.vue").default;
const accounting_jv_detail =
    require("./components/accounts/accounting_jv_detail.vue").default;
const accounting_jv_create =
    require("./components/accounts/accounting_jv_create.vue").default;
