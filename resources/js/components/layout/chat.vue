                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="d-flex align-items-center w-100">
                                <div class="sidebar-profile-toggle">
                                    <div class="avatar avatar-border">
                                        <img v-if="this.fetchimage!=''" v-bind:src="`public/images/profile_images/${this.fetchimage}`" alt="user_avatar" height="42" width="42" />
                                        <img v-else src="public/images/profile_images/pro.png" alt="user_avatar" height="42" width="42" />
                        ...
                        <div id="users-list" class="chat-user-list-wrapper list-group">
                            <h4 class="chat-list-title">Unread Inbox</h4>
                            <ul class="chat-users-list chat-list media-list" v-for="chatusers1 in chatusers">
                                <li @click="messages(chatusers1.email)">
                                    <span class="avatar"><img v-bind:src="`public/images/profile_images/${chatusers1.photo}`" height="42" width="42" alt="Generic placeholder image" />
                                    ...
                                    <div class="chat-meta text-nowrap">
                                        <small class="float-end mb-25 chat-time">{{chatusers1.emp_code}}</small>
                                        <span class="badge bg-danger rounded-pill float-end">{{chatusers1.email}}</span>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="chat-users-list contact-list media-list" v-for="overallusers1 in overallusers">
                                <li @click="messages(overallusers1.email)">
                                    <span class="avatar">
                                        <img v-bind:src="`public/images/profile_images/${overallusers1.photo}`" height="42" width="42" alt="Generic placeholder " />
                                    </span>
                                    <div class="chat-info">
                                        <h6 class="mb-0">{{overallusers1.first_name}} {{overallusers1.last_name}}</h6>
                                        <p class="card-text text-truncate">
                                            {{overallusers1.email}}
                                        </p>
                                    </div>
                                    <div class="chat-meta text-nowrap">
                                        <small class="float-end mb-25 chat-time">{{overallusers1.emp_code}}</small>
                                    </div>
                                </li>
                                <li class="no-results">
                ...
                <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="content-body">
                        ...
                        <section class="chat-app-window">
                            ...
                            <div v-for="userdetails1 in userdetails">
                                <div class="chat-navbar">
                                    <header class="chat-header">
                                             ...
                                             <div class="d-flex justify-content-left align-items-center">
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar  me-1">
                                                            <img v-bind:src="`public/images/profile_images/${userdetails1.photo}`"alt="Avatar" height="32" width="32">
                                                           
                                                        </div>
                                                    </div>
                                                    <div class="d-flex flex-column">
                                                        <a class="user_name text-truncate text-body"><span class="fw-bolder">{{userdetails1.first_name}} {{userdetails1.last_name}} </span></a><small class="emp_post text-muted">
                                                            {{userdetails1.email}}
                                                        </small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <i class="fa-solid fa-phone cursor-pointer d-sm-block d-none font-medium-2 me-1" style="margin-right: 20px !important;"></i>
                                            <i class="fa-solid fa-video cursor-pointer d-sm-block d-none font-medium-2 me-1"></i>
                                        </div>
                                    </header>
                                </div>
                                <div v-if="message!='No Messages'" class="user-chats" style="overflow-y: auto;max-height: 450px;min-height:450px">
                                    <div class="chats" v-for="m in message">
                                        <div class="chat" v-if="m.user_from==fetchsession">
                                            <div class="chat-avatar">
                                                <span class="avatar box-shadow-1 cursor-pointer">
                                                    <img v-bind:src="`public/images/profile_images/${fetchimage}`" alt="avatar" height="36" width="36" />
                                                </span>
                                            </div>
                                            <div class="chat-body">
                                        ...
                                        <div v-else class="chat chat-left">
                                            <div class="chat-avatar">
                                                <span class="avatar box-shadow-1 cursor-pointer">
                                                    <img v-bind:src="`public/images/profile_images/${userdetails1.photo}`" alt="avatar" height="36" width="36" />
                                                </span>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-content">
                                ...
                                <div v-else class="start-chat-area" style="overflow-y: auto;max-height: 430px;min-height:430px">
                                    <div class="mb-1 start-chat-icon">
                                        <i style="font-size:70px !important;margin-left:-15px" class="fa-solid fa-comment"></i>
                                    </div>
                                    <h4 class="sidebar-toggle start-chat-text">No Messages</h4>
                                </div>
                                <div class="chat-app-form" >
                                    <div class="input-group input-group-merge me-1 form-send-message">
                                        <span class="speech-to-text input-group-text"><i class="fa-solid fa-comments"></i>
                                        </span>

                                        <input type="text" v-model="message_input" class="form-control message" placeholder="Type your message or use speech to text" v-on:keyup.enter="enterChat()"  />
                            ...
                            <div v-else-if="conID==''" class="start-chat-area" style="overflow-y: scroll;max-height: 600px;">
                                <div class="mb-1 start-chat-icon">
                                    <i style="font-size:70px !important;margin-left:-15px" class="fa-solid fa-comment"></i>
                                </div>
