                ...
                <div class="content-body">
                            ...
                            <div class="card" data-bs-target="#viewposts" data-bs-toggle="modal" style="cursor:pointer;">
                                <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div>
                                        ...
                                        <p class="card-text text-info">Total posts</p>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div>
                                        ...
                                        <p class="card-text text-info">Applications</p>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div>
                                        ...
                                        <p class="card-text text-info">Ongoing interviews</p>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div>
                                        ...
                                        <p class="card-text text-info">Short listed</p>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                ...
                                <div class="card-body p-0" style="position: relative;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                                ...
                                                <g id="SvgjsG1732" class="apexcharts-inner apexcharts-graphical" transform="translate(68.5, -10)">
                                                    ...
                                                    <g id="SvgjsG1736" class="apexcharts-radialbar">
                                                        <g id="SvgjsG1737">
                                                            ...
                                                            <g id="SvgjsG1745">
                                                                <g id="SvgjsG1749" class="apexcharts-series apexcharts-radial-series" seriesName="seriesx1" rel="1" data:realIndex="0"><path id="SvgjsPath1754" d="M 77.85670731707313 184.82445114399718 A 89.28658536585367 89.28658536585367 0 1 1 210.6873193374061 121.46749921697622" fill="none" fill-opacity="0.85" stroke="url(#SvgjsLinearGradient1750)" stroke-opacity="1" stroke-linecap="round" stroke-width="7.060975609756099" stroke-dasharray="0" class="apexcharts-radialbar-area apexcharts-radialbar-slice-0" data:angle="249" data:value="83" index="0" j="0" data:pathOrig="M 77.85670731707313 184.82445114399718 A 89.28658536585367 89.28658536585367 0 1 1 210.6873193374061 121.46749921697622" filter="url(#SvgjsFilter1782)"></path></g>
                                                                <circle id="SvgjsCircle1746" r="82.52134146341464" cx="122.5" cy="107.5" class="apexcharts-radialbar-hollow" fill="transparent"></circle>
                                                                <g id="SvgjsG1747" class="apexcharts-datalabels-group" transform="translate(0, 0) scale(1)" style="opacity: 1;">
                                                                    <text id="SvgjsText1748" font-family="Helvetica, Arial, sans-serif" x="122.5" y="123.5" text-anchor="middle" dominant-baseline="auto" font-size="2.86rem" font-weight="600" fill="#5e5873" class="apexcharts-text apexcharts-datalabel-value" style="font-family: Helvetica, Arial, sans-serif;">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="card card-employee-task">
                                ...
                                <div class="card-body" style="height:308px; overflow:auto;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div class="employee-task d-flex justify-content-between align-items-center" v-for="mnth_hir1 in mnth_hir" :key="mnth_hir1" data-bs-target="#viewhiredcandidate" data-bs-toggle="modal" style="cursor:pointer;">
                    ...
                    <div class="col-md-12">
                        <div clas="card" >
                            <div class="table-responsive" style="overflow-x: initial !important;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                <table class="table mb-0" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <thead>
                                        <tr v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                            <th style="width: 34%; text-align: center; white-space: nowrap;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">Post name</th>
                                            <th style="width: 21%; text-align: center; white-space: nowrap;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">Applications received</th>
                                            <th style="width: 0px; text-align: center; white-space: nowrap;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']"></th>
                                            <th style="width: auto; text-align: center; white-space: nowrap;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">Ongoing interviews</th>
                                            <th style="width: auto; text-align: center; white-space: nowrap;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">Offered</th>
                                        </tr>
                                    </thead>
                                </table>
                                <div class="table-responsive" style="max-height:300px ;overflow-y:auto;">
                                    <table class="table mb-0">
                                        <tbody>
                                            <tr v-for="jobs1 in jobs" style="height: 1em; overflow: hidden;" :key="jobs1">
                                                ...
                                                <td style="font-size:0px; overflow: hidden; width: 0px; max-height:10px">
                                                    <span v-for="candidates1 in candidates" :key="candidates1" v-if="candidates1.JobID==jobs1.JobID">{{a=a+1}}</span>
                                                </td>
                                                <td style="vertical-align: middle; text-align: center; white-space: nowrap;">
                                                    <span class="badge rounded-pill badge-light-primary me-1">{{a}}</span>
                                                </td>
                                                <td style="font-size: 0px; overflow: hidden; width: 0px; max-height: 10px">
                                                    <span v-for="interview1 in interview" :key="interview1" v-if="interview1.JobID==jobs1.JobID && interview1.hire_sts!='1'">{{b=b+1}}</span>
                                                </td>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body" style="height: 500px; overflow: scroll;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
