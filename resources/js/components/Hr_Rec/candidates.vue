        ...
        <div class="app-content content ">
            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    ...
                    <!--Search code-->
                    <div class="card-body border-bottom" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                        <h4 class="card-title" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">Search & Filter</h4>
                        <div class="row" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                            <div class="col-md-3" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                <label class="form-label" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">Name</label>
                                <input v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']" type="text" @change="search_candidate()" v-model="s_name" class="form-control" placeholder="Name" />
                            </div>
                            <div class="col-md-3" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                <label v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']" class="form-label">Post Applied</label>
                                <select v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']" @change="search_candidate()" v-model="s_post" class="form-select mb-md-0 mb-2">
                                    <option value="">Any Post</option>
                                    <option v-for='p_detail1 in p_detail' :value='p_detail1.PostTitle'>{{p_detail1.PostTitle}}</option>
                                </select>
                            </div>
                            <div class="col-md-3" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                <label v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']" class="form-label">Address</label>
                                <input v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']" @change="search_candidate()" type="text" v-model="s_address" class="form-control" placeholder="Address" />
                            </div>
                            <div class="col-md-3" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                    ...
                    <div style="margin-bottom:20px;" class="d-flex justify-content-between align-items-center header-actions mx-2 row mt-75" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                        <div class="col-sm-12 col-lg-12 ps-xl-75 ps-0" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                            <div style="float:left;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('job_detail2')
                .then(data => this.p_detail = data.data)
                .catch(error => { });
