            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                            <div class="card">
                                <div class="row" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div class="col-sm-5" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                        <div class="d-flex align-items-end justify-content-center h-100" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                            <img src="public/app-assets/images/illustration/faq-illustrations.svg" class="img-fluid mt-2" alt="Image" width="85" />
                                        </div>
                                    </div>
                                    <div class="col-sm-7" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                        <div class="card-body text-sm-end text-center ps-sm-0" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#postjob">
                                                + Post a job
                                            </button>
                                        </div>
                                    </div>
                ...
                <!-- Post job modal -->
                <div class="modal fade" id="postjob" tabindex="-1" aria-labelledby="addNewAddressTitle" aria-hidden="true" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                    <div class="modal-dialog modal-dialog-centered modal-lg" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                        <div class="modal-content" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                            <div class="modal-header bg-transparent" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body pb-5 px-sm-4 mx-50" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
