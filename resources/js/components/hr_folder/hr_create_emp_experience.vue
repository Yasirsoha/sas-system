                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group xz_form  row animated slideInDown" v-for="count in counter" :key="count" style="border: 2px solid lightgrey;padding: 10px;margin-top:5px;margin-bottom:5px">
