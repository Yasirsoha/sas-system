...
<div class="col-md-4" style="margin-top:30px">
    ...
    <div class="ng-star-inserted">
        <a data-bs-toggle="modal" data-bs-target="#EmployeeReportToggle"><i class="fa-solid fa-star" style="font-size:16px !important;padding-right:20px"></i><span> Individual Employee Report</span></a>
        <a data-bs-toggle="modal" data-bs-target="#PayrollReportToggle"><i class="fa-solid fa-star" style="font-size:16px !important;padding-right:20px"></i><span> Session Wise Payroll Report</span></a>
    </div>
</div>
</div>
<br>
...
<!-- Modal 1-->
<div class="modal fade" id="EmployeeReportToggle" aria-labelledby="EmployeeReportToggle" tabindex="-1" style="display: none" aria-hidden="true">
<div v-if="ind_employee_report==''" class="modal-dialog modal-dialog-centered">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="modalToggleLabel">Filter Individual Employee Report</h5>
...
<div class="col-md-12">
    ...
    <select v-model="ind_employee_report" class="form-control">
...
<button class="btn btn-primary" @click="individual_report_handler()">
View Report
</button>
...
<h4 class="modal-title" style="width:60%"><span style="width:60%">Indivdual Employee Report </span> </h4>
<span>Session Name: </span>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" @click="ind_attendance_re2()"></button>
</div>
...
<div class="modal-body"  >
    ...
    <div class="table-responsive" >
        <table class="" style="width:100%" id="">
            <tr>
                <td style="width:70%;font-size:bold"><strong>Employee Code: </strong></td>
                <td style="width:30%;font-size:bold"><strong>Total Days: </strong></td>
            </tr>
            <tr>
                <td style="width:70%;font-size:bold"><strong>Name: </strong></td>
                <td style="width:30%;font-size:bold"><strong>Present Days:</strong></td>
            </tr>
            <tr>
                <td style="width:70%;font-size:bold"><strong>Designation: </strong></td>
                <td style="width:30%;font-size:bold"><strong>Absent Days: </strong></td>
            </tr>
            <tr>
                <td style="width:70%;font-size:bold"><strong>Department: </strong></td>
                <td style="width:30%;font-size:bold"><strong>Leaves: </strong></td>
            </tr>
            <tr>
                <td style="width:70%;font-size:bold"><strong>Location: </strong></td>
    ...
    <div class="table-responsive">
        <table class="table Ind_Employee_Report">
            <thead style="">
                <tr>
  ...
  <div class="modal-body" id="Ind_Employee_Report" >
...
<div class="modal-footer">
    <button type="button" @click="html_table_to_excel('xlsx','Ind_Employee_Report')" class="btn btn-gradient-info">Excel</button>
    <button type="button" @click="generateReport()" class="btn btn-gradient-info">Pdf</button>
    <button type="button" class="btn btn-gradient-primary" data-bs-dismiss="modal" @click="ind_attendance_re2()">close</button>
</div>
...
getindattendance_ind(){
    ...
    axios.get('./getindatt_count/'+this.ind_employee_report)
.then(response =>{
     this.att_individual_count = response.data;  
        })
  ...
  axios.get('./getindatt_report/'+this.ind_employee_report)
.then(response =>{
     this.att_individual_report = response.data;  
        })
