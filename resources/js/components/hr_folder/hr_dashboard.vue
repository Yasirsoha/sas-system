            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-xl-4 col-md-6 col-12 col-xs-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <h5>Welcome Back 🎉</h5>
                        ...
                        <div class="col-xl-8 col-md-6 col-12">
                            <div class="card card-statistics">
                                <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <h4 class="card-title">Today's Employee Attendance</h4>

                                </div>
                                <div class="card-body statistics-body" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div class="row">
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="card card-developer-meetup">
                                <div class="meetup-img-wrapper rounded-top text-center" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']"><h4 style="font-size:14px">Today's Attendance Of All Departments</h4></div>
                            <div class="card card-company-table">
                                <div class="card-body p-0" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                    <div class="table-responsive">
                                        ...
                                        <div class="card-body" style="height: 233px; overflow-y: scroll;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                            <table class="table text-center">
                                                <tbody>
                                                    <tr v-for="attendance1 in attendance" :key="attendance1">
                                                        <td style="width:38%">
                                                        ...
                                                        <td class="text-nowrap">
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-bolder mb-25">{{attendance1.TotalEmployee}}</span>
                                                            </div>
                                                        </td>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="row match-height">
                                ...
                                <div class="col-lg-6 col-md-3 col-6">
                                    <div class="card">
                                        <div class="card-body pb-50" style="position: relative;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                            <h6>Males</h6>
                                            ...
                                            <div class="resize-triggers"><div class="expand-trigger"><div style="width: 178px; height: 181px;"></div></div><div class="contract-trigger"></div></div>
                                        </div>
                                    </div>
                                </div>
                                <!--/ Bar Chart - Orders -->
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']"><h4 style="font-size:14px">Employees Job Status Expiry Detail ({{emp_count.status_exp_cnt}})</h4></div>
                        <div class="card card-company-table">
                            <div class="card-body p-0" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                <div class="table-responsive">
                                    <table class="table">
                                    ...
                                    <div class="card-body" style="height: 402px; overflow-y: scroll;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                        <table class="table">
                                            <tbody>
                                                <tr v-for="exp_emp1 in exp_emp" :key="exp_emp1">
                                                    ...
                                                    <td class="text-center" style="width: 28%;">{{exp_emp1.Department}}</td>
                                                    <td style="text-align:right; width: 22%;">{{exp_emp1.ProbationEnd}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="card-header" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']"><h4 style="font-size:14px">Employees CNIC Expiry Detail ({{emp_count.cnic_exp_cnt}})</h4></div>
                        <div class="card card-company-table">
                            <div class="card-body p-0" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                <div class="table-responsive">
                                    <table class="table">
                                    ...
                                    <div class="card-body" style="height: 402px; overflow-y: scroll;" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                        <table class="table" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                            <tbody>
                                                <tr v-for="exp_cnic1 in exp_cnic" :key="exp_cnic1">
                                                    <td class="sorting_1" style="width: 50%;">
                                                        <div class="d-flex justify-content-left align-items-center">
                                                            <div class="avatar-wrapper">
                                                                <div class="avatar  me-1">
                                                            ...
                                                            <div class="d-flex flex-column" v-bind:class="[(toggle=='black')? 'bg-dark' : 'bg-light']">
                                                                <a class="user_name text-truncate text-body"><span class="fw-bolder">{{exp_cnic1.Name}}</span></a><small class="emp_post text-muted">
                                                    ...
                                                    <td class="text-center" style="width: 28%;">{{exp_cnic1.Department}}</td>
                                                    <td style="text-align: right; width: 22%;">{{exp_cnic1.CnicExpiry}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
