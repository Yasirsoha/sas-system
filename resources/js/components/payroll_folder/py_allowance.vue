                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="row" style="margin-top:20px">
                                    ...
                                    <div class="col-md-3 col-12 mb-2 position-relative">
                                        <button data-bs-toggle="modal" data-bs-target="#applyallowance" class="btn btn-primary">Apply Allowance</button>
                                    </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-size:10px !important;">Allowance Type</th>
                                        ...
                                        <tbody>
                                            <tr v-for="all_sals1 in all_sals.data">
                                                ...
                                                <td style="text-align:center;border-right:1px solid lightgrey">{{all_sals1.StartSession}}</td>
                                                <td style="text-align:center;border-right:1px solid lightgrey">{{all_sals1.AllowanceType}}</td>
                                                <td style="text-align:center;border-right:1px solid lightgrey">{{all_sals1.AllowanceAmount}}</td>
                                            ...
                                            <td style="border-right:1px solid lightgrey;text-align:center;">
                                             <a v-if="all_sals1.Status=='Pending'" @click="fetch_arrear_id(all_sals1.AllowanceID)" data-bs-toggle="modal" data-bs-target="#hireinterview1"> 
                                               <span class="badge bg-gradient-warning" style="cursor: pointer;">Pending</span>
                                                ...
                                                <td>
                                                    <a v-if="all_sals1.Status=='Pending'"  @click="fetch_emp_payroll(all_sals1.AllowanceID)" data-bs-toggle="modal" data-bs-target="#editpayroll"><i    style="color:#d42f2f" class="fa-solid fa-pencil"></i><span></span></a>
                    ...
                    <div class="modal fade" id="applyallowance" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-md modal-dialog-centered modal-edit-user">
                            ...
                            <div class="modal-content">
                             ...
                             <div  class="col-md-12">
                                <label class="form-label" for="modalAddCardName">Allowance Type</label>
