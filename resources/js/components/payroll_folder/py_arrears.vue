                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-size:10px !important;">Arrear Session</th>
                                        ...
                                        <tbody>
                                            <tr v-for="all_sals1 in all_sals.data">
                                                ...
                                                <td style="text-align:center;border-right:1px solid lightgrey">{{all_sals1.ArrearDate}}</td>
                                                ...
                                                <td style="text-align:center;border-right:1px solid lightgrey">{{all_sals1.ArrearsAmount}}</td>
                                                ...
                                                <td>
                                                    <a v-if="all_sals1.Status=='Pending'" @click="fetch_emp_payroll(all_sals1.ArrearsID)" data-bs-toggle="modal" data-bs-target="#editpayroll"><i style="color:#d42f2f" class="fa-solid fa-pencil"></i><span></span></a>
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <div class="text-center mb-2">
                                        ...
                                        <div class="text-center" style="text-align:center">
                                            <button type="button" :disabled="disabled" @click="delay()"  class="btn btn-primary waves-effect waves-float waves-light" data-bs-dismiss="modal" aria-label="Close">Yes</button>
