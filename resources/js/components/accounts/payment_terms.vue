                                                ...
                                                <tr class="odd" v-for="adsdata1 in adsdata.data" :key="adsdata1">
                                                    ...
                                                    <td>
                                                       <div style="margin-bottom:10px" class="form-check form-check-info form-switch">
                                                        <input style="width: 50px;" type="checkbox" v-model="payment_status1" class="form-check-input" id="customSwitch3">
                                                    </div> 
                                                    </td>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                            ...
                            v-if="payment_name == ''"
                            >{{ payment_name_error }}</span
                          >
                            </div>
                            <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Days</label>
                               <input type="number" class="form-control" v-model="payment_days" />
                               <span
                            style="color: #db4437; font-size: 11px"
                            v-if="payment_days == ''"
                            >{{payment_days_error }}</span
                          >
                            </div>
                             <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Payment Computation</label>
                          ...
                          >
                            ...
                            <div class="col-md-6 col-12" v-if="this.payment_computation=='Percentage'">
                                <label class="form-label" for="modalAddCardName">Extra Amount in Invoice</label>
                                <input type="number" v-model="payment_amount" placeholder="Type Percentage Value of Payment" class="form-control" style="" value="0" />
                           <span
                            style="color: #db4437; font-size: 11px"
                            v-if="payment_amount == ''"
                            >{{ payment_amount_error }}</span
                          >
                           </div>
                            <div class="col-md-6 col-12" v-if="this.payment_computation=='Fixed'">
                                <label class="form-label" for="modalAddCardName">Extra Amount in Invoice</label>
                                <input type="number" placeholder="Type Fixed Value of Payment" v-model="payment_amount" class="form-control" style="" value="0" />
                            </div>
                             <div class="col-md-6 col-12">
...
if (
        ...
        if (this.payment_name == "") {
          this.payment_name_error = "Please enter payment terms";
        }
        if (this.payment_days == "") {
          this.payment_days_error = "Please enter days";
        }
        if (this.payment_computation == "") {
          this.payment_computation_error = "Please select payment computation";
        }
        if (this.payment_amount == "") {
          this.payment_amount_error = "Please enter amount";
        }
        
      }
      if(this.payment_name && this.payment_days && this.payment_computation && this.payment_amount){
