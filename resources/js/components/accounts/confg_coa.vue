        ...
        <div class="modal-content">
          ...
          <div class="modal-body px-sm-5 mx-50 pb-5">
            ...
            >
              ...
              <div class="col-md-6 col-12">
                <label style="width: 100%; padding-left: 60px"
                  >Allow Reconcilation</label
                >
                <div
                  style="
                    margin-bottom: 10px;
...
export default {
  ...
  mounted() {
    axios.get("./fetch_user_hr_roles").then((response) => {
