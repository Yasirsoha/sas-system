                ...
                <div class="content-body">
                    ...
                    <div class="row invoice-add">
                            ...
                            <div class="card invoice-preview-card">
                                ...
                                <div class="card-body  pb-0">
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0" style="margin-bottom:0px">
                                         <div v-for='companydetail1 in companydetail' style="margin-left:30px" :key="companydetail1">
                                        ...
                                        <div class="invoice-number-date mt-md-0 mt-2">
                                            <div class="d-flex align-items-center justify-content-md-end mb-1">
                                                <h4 class="invoice-title">Quotation Id:</h4>
                                ...
                                <!-- Header ends -->
                               <div class="divider">
                                        <div class="divider-text" style="font-size: 24px;font-weight: 900;">Quotation</div>
                                    </div>
                                ...
                                <div class="form-group xz_form  row animated slideInDown" v-for="count in counter" :id="count" style="margin-top:40px" :key="count">
                                                    ...
                                                    <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                        <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                            <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                                ...
                                                                <textarea name="second[]" class="form-control mt-2" rows="1" placeholder="Customization & Bug Fixes"></textarea>
                                                            </div>
                                                            <div class="col-lg-3 col-12 my-lg-0 my-2">
                                                                <p class="card-text col-title mb-md-2 mb-0">Cost</p>
                                                                <input name="third[]" type="number" class="form-control"  placeholder="Per Item Cost" />
                                                                <div class="mt-2">
                                                            ...
                                                            <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                               ...
                                                               <input name="fiveth[]" type="number" readonly class="form-control"  placeholder="" />
                                                            </div>
                                                        </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <button class="btn btn-primary w-100 mb-75">Post Quotation</button>
