                ...
                <div class="content-body">
                    ...
                    <div class="row invoice-add">
                        ...
                        <div class="col-xl-9 col-md-8 col-12">
                            <div class="card invoice-preview-card">
                                ...
                                <div class="card-body  pb-0">
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0" style="margin-bottom:0px">
                                         <div v-for='companydetail1 in companydetail' :key="companydetail1" style="margin-left:30px">
                                        ...
                                        <div class="invoice-number-date mt-md-0 mt-2">
                                            <div class="d-flex align-items-center justify-content-md-end mb-1">
                                                <h4 class="invoice-title">JV Id:</h4>
                                                <div class="input-group input-group-merge invoice-edit-input-group">
                                                    <div class="input-group-text">
                                                       <i class="fa-solid fa-hashtag"></i>
                                                    </div>
                                                    <input type="text" class="form-control invoice-edit-input" placeholder="53634" v-model="jv_id" />
                                                    <span
                            ...
                            >
                                            ...
                                            <div class="d-flex align-items-center mb-1">
                                                ...
                                                <input type="date" class="form-control invoice-edit-input " v-model="jv_date" />
                                                <span
                              style="color: #db4437; font-size: 11px"
                              v-if="jv_date == ''"
                              >{{ jv_date_error }}</span
                            >
                               ...
                               <div class="divider">
                                ...
                                <div class="col-lg-3 col-12 col-md-3">
                                  <p class="card-text col-title mb-md-50 mb-0">Account</p>
                                </div>
                                 <div class="col-lg-5 col-12 my-lg-0 my-2">
                                  <p class="card-text col-title mb-md-2 mb-0">Narration</p>
                                 </div>
                                ...
                                <div class="form-group xz_form  row animated slideInDown" v-for="count in counter" :key="count" style="">
                                                    ...
                                                    <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                        <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                            <div class="col-lg-3 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                                ...
                                                                <select class="form-select item-details" name="first[]" v-model="jv_details">
                              ...
                              style="color: #db4437; font-size: 11px"
                              v-if="jv_details == ''"
                              >{{ jv_details_error }}</span
                            >
                                                            </div>
                                                           
                                                            <div class="col-lg-5 col-12 my-lg-0 my-2">
                                                               
                                                                <input type="text" class="form-control" name="fourth[]" v-model="narration"   />
                                                                <span
                              style="color: #db4437; font-size: 11px"
                              v-if="narration == ''"
                            ...
                            >
                                                            ...
                                                            <div class="col-lg-2 col-12 mt-lg-0 mt-2">
                                                                ...
                                                                <input  type="number" step="0.01" v-model="credit" class="form-control" value="00.00" name="fourth[]"   /> 
                                                           <span
                              style="color: #db4437; font-size: 11px"
                              v-if="credit == ''"
                              >{{ credit_error }}</span
                            >
                                                             ...
                                                             <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                                ...
                                                                <input  type="number" v-model="debit" step="0.01" class="form-control" value="00.00" name="five[]"   /> 
                                                            <span
                              style="color: #db4437; font-size: 11px"
                              v-if="debit == ''"
                              >{{ debit_error }}</span
                                ...
                                <div class="col-lg-3 col-12 col-md-3">
                                 ...
                                 <div class="col-lg-4 col-12 my-lg-0 my-2">
                                  ...
                                  <div class="col-lg-2 col-12 mt-lg-0 mt-2" style="margin-left:6%">
                                   <input  type="number" readonly step="0.01" class="form-control" value="00.00" name="five[]" v-model="credit"   /> 
                                   <span
                              style="color: #db4437; font-size: 11px"
                              v-if="credit == ''"
                              >{{ credit_error }}</span
                            >
                                   ...
                                   <div class="col-lg-2 col-12 my-lg-0 my-2">
                                      <input  type="number" v-model="debit" readonly step="0.01" class="form-control" value="00.00" name="five[]"   /> 
                                   <span
                              style="color: #db4437; font-size: 11px"
                              v-if="debit == ''"
                              >{{ debit_error }}</span
                        ...
                        <div class="col-xl-3 col-md-4 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <button @click="postHandler" class="btn btn-primary w-100 mb-75">Post </button>
...
if (
        ...
        if (this.credit == "") {
          this.credit_error = "Please enter credits";
        }
        if (this.debit == "") {
          this.debit_error = "Please enter debits";
        }
        if (this.jv_id == "") {
          this.jv_id_error = "Please enter jv id";
        }
        if (this.jv_date == "") {
          this.jv_date_error = "Please enter date";
        }
        if (this.narration == "") {
          this.narration_error = "Please enter narration";
        }
        if (this.jv_details == "") {
          this.jv_details_error = "Please select account";
        }
