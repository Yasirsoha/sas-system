          ...
          <div class="modal-body px-sm-5 mx-50 pb-5">
            ...
            >
              ...
              <div class="col-md-12 col-12">
                <label class="form-label" for="modalAddCardName"
                  >Type Office Or Delivery Address</label
                >
                <textarea
                  placeholder="Type Office Or Delivery Address"
      ...
      if (
        ...
        this.$toastr.e("Please fill required fields!", "Caution!");
        {
          ...
          if (this.phone_number == "") {
            this.phone_number_error = "Please enter phone number";
          }
          if (this.mobile_number == "") {
            this.mobile_number_error = "Please enter mobile number";
          }
          if (this.email == "") {
            this.email_error = "Please enter email";
          }
          if (this.website == "") {
            this.website_error = "Please paster website link";
          }
          if (this.delivery_address == "") {
            this.delivery_address_error =
              "Please eneter full delivery or office address";
          }
        }
      }
    },
