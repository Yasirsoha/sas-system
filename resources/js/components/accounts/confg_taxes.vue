            ...
            >
              ...
              <div class="col-md-6 col-12">
                <label class="form-label" for="modalAddCardName"
                  >Tax Scope</label
                >
                <select class="form-select" v-model="tax_scope">
              ...
              <div
                ...
                v-if="this.tax_computation == 'Percentage'"
              >
                <label class="form-label" for="modalAddCardName">Amount</label>
                <input
                  type="number"
                  v-model="tax_amount"
                  placeholder="Type Percentage Value of Tax"
                  class="form-control"
                  style=""
                />
                <span
              ...
              <div
                class="col-md-6 col-12"
                v-if="this.tax_computation == 'Fixed'"
              >
                <label class="form-label" for="modalAddCardName">Amount</label>
                <input
                  type="number"
                  placeholder="Type Fixed Value of Tax"
                  v-model="Amount"
                  class="form-control"
                  style=""
                />
  ...
  methods: {
    ...
    submit_session() {
      if (
        this.tax_name == "" ||
        this.tax_type == "" ||
        this.tax_computation == "" ||
        this.Amount == "" ||
        this.tax_scope == ""
      ) {
        this.$toastr.e("Please fill required fields!", "Caution!");
        if (this.tax_name == "") {
          this.tax_name_error = "Please enter name";
        }
        if (this.tax_type == "") {
          this.tax_type_error = "Please select type";
        }
      }
      if (this.tax_computation == "") {
        this.tax_computation_error = "Please select computation";
      }
      if (this.Amount == "") {
        this.Amount_error = "Please enter amount";
      }
      if (this.tax_scope == "") {
        this.tax_scope_error = "Please select scope";
      }
      if (
        this.tax_name &&
        this.tax_type &&
