      ...
      <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
          <section class="app-user-view-account">
            <div class="row">
              <!-- User Sidebar -->
              <div class="col-xl-5 col-lg-5 col-md-5 order-1 col-12 order-md-0">
                <!-- User Card -->
                <div class="card">
                                  ...
                                  >
                                    ...
                                    <div>
                                      ...
                                      <div
                                        ...
                                        class="
                                          form-check form-check-info form-switch
                                        "
                                      >
                                        <input
                                          style="width: 50px"
                                    ...
                                    <table class="table table-hover">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>Furniture</td>
                                          <td>
                                            Furniture Detail Furniture Detail
                                            Furniture Detail
                                          </td>
...
export default {
  ...
  methods: {
    ...
    submit_cateogory() {
      if (this.product_name == "" || this.Description == "") {
        this.$toastr.e("Please fill required fields!", "Caution!");
        if (this.product_name == "") {
          this.product_name_error = "Please enter category name";
        }
        if (this.Description == "") {
