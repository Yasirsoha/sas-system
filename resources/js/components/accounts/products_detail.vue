								 ...
								 <div class="col-sm-6 col-lg-6 ps-xl-75 ps-0">
                                    <div class="dt-action-buttons d-flex align-items-center justify-content-center justify-content-lg-end flex-lg-nowrap flex-wrap">
                                        ...
                                        <div class="dt-buttons d-inline-flex mt-50">
                                            <a style="float:left" data-bs-toggle="modal" data-bs-target="#addNewCard" class="btn btn-outline-primary waves-effect" type="button">Create New Product</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <td>Sofa</td>
                                     <td>Furniture</td>
                                      <td>Goods</td>
                                       <td>Rs. 14.00</td>
                                        <td><span class="badge badge-light-secondary">Sales Tax 17% </span></td>
                                        <td>Rs. 14.00</td>
                                          <td><span class="badge badge-light-secondary">Purchase Tax 17%</span></td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <span  data-bs-target="#upd_sts" class="dropdown-item">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-transparent">
                        <h3 class="text-center mb-1" id="addNewCardTitle">Create New Product</h3>
                    ...
                    <div class="modal-body px-sm-5 mx-50 pb-5">
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <label class="form-label" for="modalAddCardName">Customer Name</label>
                                <input type="text" v-model="product_name" class="form-control" placeholder='Type Product Name' style="" />
                                <span
                          ...
                          >
					        ...
					        <div class="mb-1">
					            ...
					            <div class="demo-inline-spacing">
					                ...
					                <div class="form-check form-check-inline" style="margin-top:0px">
					                    <input class="form-check-input" checked="" type="checkbox" v-model="sold" name="inlineRadioOptions" id="inlineRadio2" value="Company">
                             ...
                             <div class="col-md-6 col-12">
                                <label class="form-label" for="modalAddCardName">Product Type</label>
                          ...
                          >
                               ...
                               <span >Services are physical products for which you don't manage the inventory level: Inventory always available on Goods</span>
                               </div>

                            </div>
                            <div class="col-md-6 col-12">
                            	<div class="form-group">
                            	 <label class="form-label" for="modalAddCardName">Purchase Cost</label>
                                 <input type="number" placeholder="Type Purchase Cost" v-model="purchase_cost" class="form-control" style="" value="0" />
                                 <span
                            style="color: #db4437; font-size: 11px"
                            v-if="purchase_cost == ''"
                          ...
                          >
                                ...
                                <div class="form-group" >
                                <label class="form-label" for="modalAddCardName">Purchase Tax</label>
                          ...
                          >
                               ...
                               <div class="form-group">
                                <label class="form-label" for="modalAddCardName">Sale Value</label>
                                <input type="number" placeholder="Type Sale Cost" v-model="sale_cost" class="form-control" style=""  />
                                <span
                            style="color: #db4437; font-size: 11px"
                            v-if="sale_cost == ''"
                            >{{ sale_cost_error}}</span
                          >
                            </div>
                            <div class="form-group" >
                                <label class="form-label" for="modalAddCardName">Sale Tax</label>
                          ...
                          >
							...
							<button @click="submit_customer()" type="button" class="btn btn-primary mt-1 me-1 waves-effect waves-float waves-light">Save  Product Detail</button>
							</div>
                        </form>
                    </div>
                </div>
...
MaskedInput
    ...
    methods: {
        submit_customer(){
          if(this.sale_cost=="" || this.sale_tax=="" || this.purchase_cost=="" || this.purchase_tax=="" || this.product_name=="" || this.product_type==""){
                    this.$toastr.e("Please fill required fields!", "Caution!");
                    {
                        if (this.sale_cost == "") {
            this.sale_cost_error = "Please enter sale cost";
          }
          if (this.sale_tax == "") {
