                ...
                <div class="content-body">
                    ...
                    <div class="row invoice-add">
                                    ...
                                    <div class="row row-bill-to invoice-spacing" style="margin-top:0px">
                                        ...
                                        <div class="col-xl-4 p-0 ps-xl-2 mt-xl-0 mt-2">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td class="pe-1">Total Payment:</td>
                                                        <td><strong>$12,110.55</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-1">Pending Payment:</td>
                                                        <td>$12</td>
                                                    </tr>
                        ...
                        <div class="col-xl-3 col-md-4 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <button class="btn btn-primary w-100 mb-75">Post PO</button>
