                                                ...
                                                <div class="dt-action-buttons d-flex align-items-center justify-content-center justify-content-lg-end flex-lg-nowrap flex-wrap">
                                                    <div class="me-1">
                                                        <div class="dataTables_filter" style="margin-top:5px">
                                                            <label>
                                                                <input autocomplete="off" id="keyword1" type="text" name="keyword1" v-model="keyword1" class="form-control" style="padding-left:70px" placeholder="Search By Department" />
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    export default {
        ...
        methods: {
                ...
                axios.post('./update_department', {
                    ...
                    .then(data => {
                        if (data.data == 'Department matched!') {
                            this.$toastr.e("Department Already Exists In Your Company", "Please try again");
                        }
                        else {
            ...
            fetch_department(id) {
                this.id1 = id;
                axios.get('fetch_department/' + this.id1)
                    .then(responce => {
            ...
            getResults() {
                ...
                axios.get('./search_department', { params: { keyword1: this.keyword1 } })
            ...
            getResult(page = 1) {
                ...
                axios.get('department_detail/?page=' + page)
